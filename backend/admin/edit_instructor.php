...
if(isset($_POST['save'])){
    ...
    $sql = "UPDATE instructors set first_name = '$first_name', last_name = '$last_name', email ='$email', phone = '$phone' where id = $instructor_id";
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="">
                                    ...
                                    <input type="hidden" value="<?php echo $row['id'] ?>" name="instructor_id">
